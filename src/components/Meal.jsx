...
import {mealData,categories} from '../data/data.js'
...
return(
    <div className='max-w-[1520px] m-auto px-4 py-12'>
       ...
       {
        foods.map((item)=>{
            return (<div key={item.name}className='border-none hover:scale-105 duration-300 '>
                ...
                <p className=' font-bold
                    ...
                    <p className='bg-orange-700 h-18 w-18 rounded-full
                     text-white px-2 py-2 -mt-10 border-8 font-bold
                     '>{item.price}</p>
                </div>
                <div className=' py-4 -mt-6 pl-2'>
