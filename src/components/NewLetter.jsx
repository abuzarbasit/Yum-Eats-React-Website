        ...
        <div className='max-w-[1520px] m-auto text-white px-4 bg-[#24262b]'>
            <div className='mx-auto grid lg:grid-cols-3'>
                ...
                <div className='flex flex-col sm:flex-row items-center justify-between w-full'>
                    <input className='p-3 flex w-full rounded-md text-black 'placeholder='Enter Email' type='email'/>
                    <button className='bg-[#00df9a] text-white rounded-md font-medium w-[200px] py-3 ml-4 my-6 px-6 border-none'>Notify Me</button>
                </div>
